...
> Use in combination with the "prompt DNA" in design-styles.md.
> Formula: `[style prompt DNA] + [scene template] + [specific content description]`

---

## 1. WeChat Public Account Cover / Article Header Image
...
- Visual impact comes first (users scan past quickly in a feed)
- Minimal or no text (the WeChat headline will overlay on top)
...
**Specs**:
- 16:9 (1200×675px) — most general purpose
- 1:1 (800×800px) — good for emphasis
- 4:3 (1200×900px) — good when info is dense
...
- AI generation preferred; HTML screenshots only when precise data tables are needed

**Recommended styles**: pick based on article tone — common picks are 01/04/10/17/18
...
- Clear type hierarchy (title 40pt+ / body 24pt+ / footnotes 16pt+)
...
**Key design considerations**:
- Optimized for long-form reading (line width 66 chars, line height 1.5–1.8)
- Clear chapter navigation system
- Unified design for headers/footers/page numbers
...
**Key design considerations**:
- Communicate core value within the first 5 seconds of the hero
...
- Consistent system design language
...
**Key design considerations**:
- Visual appeal first (competing in a waterfall feed)
- Small amount of text is allowed (but no more than 20% of the image)
- Vivid yet tasteful colors
...
**Scenario**: WeChat public account cover, introducing an AI coding tool, aiming for professional but warm
