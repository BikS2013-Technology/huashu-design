 ...
 * - Speaker notes via postMessage (supports outer renderer)
...
(function() {
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // Defense: if the script lives in <head> (instead of after </deck-stage>),
      // the parser may not have processed the child <section>s yet, and querySelectorAll would return empty.
      // Defer to the next event loop to make sure all child nodes have been parsed.
      const init = () => {
        this._collectSlides();
      ...
      if (this.ownerDocument.readyState === 'loading') {
        // Document is still parsing; let DOMContentLoaded gather all sections at once
